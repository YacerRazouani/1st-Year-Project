...
can::can()
{
   ...
   //           ajuste a droite		//https://sites.google.com/site/qeewiki/books/avr-guide/analog-input
   // sur le site ADFR est notre ADATE	//http://www.robotplatform.com/knowledge/ADC/adc_tutorial_2.html
   ADMUX  = ( 0 << REFS1 ) | ( 0 << REFS0 ) | ( 0 << ADLAR ) | ( 0 << MUX4 ) |	//gawgelha
   ...
   ADCSRA = ( 1 << ADEN ) | ( 0 << ADSC )  | ( 0 << ADATE ) | ( 0 << ADIF ) |
            ( 0 << ADIE ) | ( 1 << ADPS2 ) | ( 1 << ADPS1 ) | ( 0 << ADPS0 ) ;	//gawgelha
